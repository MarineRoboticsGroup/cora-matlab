function Lrho = construct_connection_Laplacian(measurements, var_idx_mapping)
...
for k = 1:M
    ...
    i = out_nodes(k);  %The index of the node that this edge leaves
    j = in_nodes(k);  %The index of the node that this edge enters
