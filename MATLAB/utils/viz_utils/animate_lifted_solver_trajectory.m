...
%         plot(problem_data.X_gt(robot_t_idxs{robot_idx}, 1), problem_data.X_gt(robot_t_idxs{robot_idx}, 2));
    end

%     scatter(problem_data.X_gt(l_idxs, 1), problem_data.X_gt(l_idxs, 2), 20, 'rx');
